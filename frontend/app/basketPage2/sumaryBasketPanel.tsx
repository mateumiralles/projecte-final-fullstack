...
export default function SummaryBasketPanel(props: {
    ...
    return <div className="fixed right-0 top-0 flex h-[100vh] w-3/12  justify-center border-l border-black bg-gray-100">
    <div
